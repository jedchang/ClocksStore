<template>
  <div class="cart">
    <div id="cart-sidebar" :class="{ open: isOpen }">
      <simplebar class="simplebar">
        <div class="cart-header">
          <div class="cart-icon icon">
            <span v-if="cart.carts.length > 0" id="cart-total" class=" count">
              {{ cart.carts.length }}
            </span>
          </div>
          <h2 class="cart-title">Shopping cart</h2>
          <a href="#" class="btn btn-close" @click.prevent="closeCart">
            <font-awesome-icon :icon="['fas', 'times']" />
          </a>
          <a href="#" class="btn btn-close-mobile" @click.prevent="closeCart">
        ...
        <div v-if="cart.carts.length !== 0" class="cart-content">
          <ul class="cart-product-list">
            ...
            >
              ...
              >
                <img :src="item.product.imageUrl" alt="Cart product img" />
              </router-link>
    ...
    <div class="cart-sidebar-overlay" @click="closeCart"></div>
  </div>
</template>

            ...
            <div class="shop-sidebar">
              ...
              <div class="banner-static">
                <router-link
                  ...
                  class="banner-pic"
                >
                  <img src="~@/assets/images/watches_sidebar_ad.jpg" alt="" />
                </router-link>
              </div>
            </div>
          </div>
...
import ProductsGridMode from '@/components/products/ProductsGridMode'
import ProductsListMode from '@/components/products/ProductsListMode'
